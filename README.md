...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `98.0µs` | `94.2µs` |
| [Day 2](./src/bin/02.rs) | `674.8ms` | `215.4ms` |
| [Day 3](./src/bin/03.rs) | `44.7µs` | `86.8µs` |
| [Day 4](./src/bin/04.rs) | `221.8µs` | `3.2ms` |
| [Day 5](./src/bin/05.rs) | `244.6µs` | `23.4µs` |
| [Day 6](./src/bin/06.rs) | `666.2µs` | `2.9ms` |
| [Day 8](./src/bin/08.rs) | `74.9ms` | `72.1ms` |
| [Day 9](./src/bin/09.rs) | `206.0µs` | `13.4ms` |
